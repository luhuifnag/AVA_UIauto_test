...
class RecordOperationTest(MyTest, RecordOperation):
    ...
    def test6_upload_logo(self):
        ...
        try:
            ...
            try:
                self.assertEqual(self.getAttribute(self.success_message1 ,"textContent"),"LOGO上传成功!")
                logger.info(self.getAttribute(self.success_message1 ,"textContent")) #获取 layer.msg 弹窗的信息
            except:
                self.assertEqual(self.getAttribute(self.success_message2 ,"textContent"),"LOGO上传成功!")
                logger.info(self.getAttribute(self.success_message2 ,"textContent")) #获取 layer.msg 弹窗的信息
        except Exception as msg:
            logger.error(u"异常原因：%s"%msg)
